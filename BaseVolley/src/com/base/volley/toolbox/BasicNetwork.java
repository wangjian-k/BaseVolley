...
import com.base.volley.RetryPolicy;
import com.base.volley.ServerError;
import com.base.volley.VolleyError;
import com.base.volley.VolleyLog;
...
//                }
				...
				if (request.isUpdateCookie()) {
					...
					if (!TextUtils.isEmpty(cookie) && cookie.length() > 10) {
						request.setUpdateCookie(cookie);
					}
				}
  
                return new NetworkResponse(statusCode, responseContents, responseHeaders.get("Etag"), 
                		HttpHeaderParser.parseCharset(responseHeaders), false);
