...
import com.base.volley.toolbox.ImageRequest;
import com.base.volley.toolbox.ImageRequest.BitmapHandlerCallBack;
...
public class ImageLoader {
	...
	public static void setImageBitmap(ImageView imageView, Bitmap bitmap) {
		if (Profile.getImageViewFadeIn() && Profile.mContext != null) {
			TransitionDrawable td = new TransitionDrawable(
					new Drawable[] {
							new ColorDrawable(android.R.color.transparent),
							new BitmapDrawable(Profile.mContext.getResources(),
									bitmap) });
	...
	public static String getCacheKey(String url, int maxWidth, int maxHeight) {
		...
		sb.append("#W").append(maxWidth).append("#H").append(maxHeight)
				.append(Util.urlToFileName(url));
